        ...
        <div className={styles.closetWrapper}>
            {isActive && (
                <div className={styles.dropdown}>
                    <Link to="/CreatePost" className={styles.dropdownOption1}>Create Post</Link>
                    <Link to="/Closet" className={styles.dropdownOption2}>View Closet</Link>
                </div>
            )}
            <button 
                onClick={handleClick} 
                className={`${styles.Closet} ${isActive ? styles.active : styles.inactive}`} // Apply active or inactive class
            >
                <img 
